...
from logfile_evaluation_metrics.metrics.dataset_metrics.distinctiveness_logger import DistinctivenessLogger
from logfile_evaluation_metrics.metrics.dataset_metrics.hyperparameter_logger import HyperparametreLogger
from logfile_evaluation_metrics.metrics.dataset_metrics.weighted_logger import WeightedLogger
...
# root = "C:\\Users\\User\\Desktop\\output"
# root = "C:\\Users\\User\\Desktop\\final_output"
root = "logfiles"
extractors = [
...
single_model_metric = [
        WeightedMcc(),
    RelativeCertaintyCorrectnessEval(),  # Distinctiveness
...
dataset_metric = [
        ...
        # HyperparametreLogger(),
        # DistinctivenessLogger(),
        WeightedLogger(),
